%This objective function is formulated to determine the optimal EMS of 
%MMG using three different algorithms such as MOGWO, MOMVO,
%and MSSA. All the parameters are defined. Finally the multi-objective function
% COE and LPSP Is setted to be determined so that the COE and LPSP each MG
% and MMG system has been evaluated.
